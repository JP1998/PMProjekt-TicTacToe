    ...
    <body>
        <div id="header">
            ...
            <ul>
                ...
                <li><a href="/PMProjekt-TicTacToe/multiplayer-signup">Mehrspieler</a></li>
                <li><a href="#" id="hintsign" onclick="return showHint();">?</a></li>
            </ul>
            </div>
        </div>
        <div id="content">
        ...
        <div id="footer">
            <ul>
                ...
                <li><a href="https://www.survio.com/survey/d/W2W6D9T2Z4M9K9U9H">Feedback</a></li>
            </ul>
        </div>
